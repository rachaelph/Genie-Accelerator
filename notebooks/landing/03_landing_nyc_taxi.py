...
# MAGIC %md
# MAGIC # 03 — Landing: nyc_taxi
# MAGIC
# MAGIC Auto Loader streaming ingest of `nyc_taxi.csv` from the UC volume into
# MAGIC `kpi_testing.bronze.raw_nyc_taxi`. Schema-on-read, no transformations.
# MAGIC
...
src = "/Volumes/kpi_testing/landing/raw_files/nyc_taxi/"
tgt = "kpi_testing.bronze.raw_nyc_taxi"
chk = "/Volumes/kpi_testing/landing/raw_files/_checkpoints/raw_nyc_taxi"
...
df = (
    spark.readStream
        ...
        .withColumn("__dataset__",     lit("nyc_taxi"))
)
